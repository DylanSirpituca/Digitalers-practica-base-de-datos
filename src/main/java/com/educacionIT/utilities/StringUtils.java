...
public final class StringUtils {
	...
	/**
	 * Devuelve si String es numérico o no.
	 * 
	...
	/**
	 * Pone en mayúscula el primer carácter del str proporcionado sin alterar los
	 * demas caracteres
	 *
	 * @param str {@link String} Puede proporcionar {@code null}
	 * @return el primer caracter del str proporcionado en mayúscula, {@code null}
	...
	public static boolean isEmpty(int id_cliente) {
